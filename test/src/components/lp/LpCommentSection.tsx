...
const LpCommentSection = ({ lpid }: LpCommentSectionProps) => {
  ...
  const [errorMessage, setErrorMessage] = useState<string | null>(null); // 추가
  ...
  const updateMutation = useMutation({
    ...
    onError: () => { // 추가
      setErrorMessage("댓글 수정에 실패했습니다. 다시 시도해주세요.");
    },
  });
  ...
  const deleteMutation = useMutation({
    ...
    onError: () => { // 추가
      setErrorMessage("댓글 삭제에 실패했습니다. 다시 시도해주세요.");
    },
  });
  ...
  return (
    <section className="comment-section">
      ...
      {/* 추가: 에러 메시지 표시 영역 */}
      {errorMessage && (
        <div className="comment-mutation-error">
          <p>{errorMessage}</p>
